...
<html>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=Edge,chrome=1"/>
		...
		<link rel="stylesheet" type="text/css" href="/public/css/wenzhi-style.css" />
	</head>
	<body>
    <h1 class="title">文治书院公共空间申请</h1>
		<div class="container">
			<div class="left_box">
				<h3>场地选择</h3>
				<ul class="org_select list-unstyled">
            <a style="margin-left:15px;color:#9062AF;font-size: 15px" href="/Index/wenzhi">文治书院</a>
				</ul>
			</div>
			<div class="right_box">
                ...
                <option value="1">文治报告厅</option>
					...
					<div class="header_right">
						<ul class="user_info list-unstyled">
							...
							<?php if ($auth) {?><li><a style="color:#9062AF" href="/Index/loginout">登出</a></li> <?php } else {?><li><a style="color:#9062AF" href="/Index/login">登入</a></li> <?php };?>
...
<form id="form" class="form-horizontal" role="form">
  <div class="form-group">
    <label for="room" class="col-sm-2 control-label">申请教室</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="activity" class="col-sm-2 control-label">活动</label>
    <div class="col-sm-10">
