...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input id="activity" name="activity" type="text" class="form-control" placeholder="与图书馆氛围相符">
  </div>
</div>
<div class="form-group">
...
<div class="form-group">
  <label for="drink" class="col-sm-2 control-label">饮品供应</label>
  <div class="col-sm-10">
  <label class="radio-inline">
  <input type="radio"  id="inlineRadio1" name="drink" type="radio"  value="1"> 是
</label>
<label class="radio-inline">
  <input type="radio"  id="inlineRadio2" name="drink" type="radio"  value="0"> 否
</label>
  </div>
</div>


<div class="form-group" <?if($orgid!=2){?>hidden<?}?>>
  <label for="reset" class="col-sm-2 control-label">场地重置</label>
  <div class="col-sm-10">
    <label class="checkbox-inline">
      <input type="checkbox" id="inlineCheckbox1" name="reset" type="checkbox" value="cleanup" <?if($orgid!=2){?>disabled<?}?>> 清场
    </label>
    <label class="checkbox-inline">
    <input type="checkbox" id="inlineCheckbox2" name="reset" type="checkbox" value="desk" <?if($orgid!=2){?>disabled<?}?>> 摆放桌椅
    </label>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input id="org" name="org" type="text" class="form-control" placeholder="无组织则填无组织">
  </div>
</div>
<div class="form-group">
...
<div class="form-group">
  <label for="feedback" class="col-sm-2 control-label">反馈方式</label>
  <div class="col-sm-10">
    <label class="checkbox-inline">
      <input type="checkbox" id="inlineCheckbox1" name="feedback" type="checkbox" value="email" > 邮箱
    </label>
    <label class="checkbox-inline">
    <input type="checkbox" id="inlineCheckbox2" name="feedback" type="checkbox" value="wechat" > 微信
    </label>
  </div>
</div>
